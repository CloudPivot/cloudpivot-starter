...
package com.cloudpivot.starter.core.autoconfigure;
...
import com.cloudpivot.starter.core.CloudPivotStarterVersion;

/**
 * CloudPivot Starter 版本日志打印
 *
 * @author CloudPivot Team
 * @since 2.16.0
 */
public class CloudPivotStarterVersionLogger implements ApplicationListener<ApplicationPreparedEvent> {
    ...
    public void onApplicationEvent(ApplicationPreparedEvent event) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Running with CloudPivot Starter v{}", CloudPivotStarterVersion.getVersion());
        }
    }
}