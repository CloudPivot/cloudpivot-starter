...
package com.cloudpivot.starter.extension.datapermission.autoconfigure;
...
import com.cloudpivot.starter.extension.datapermission.handler.DefaultDataPermissionHandler;
...
public class DataPermissionAutoConfiguration {
    ...
    public DataPermissionUserDataProvider dataPermissionUserDataProvider() {
        if (log.isErrorEnabled()) {
            log.error("[CloudPivot Starter] - Consider defining a bean of type '{}' in your configuration.", ResolvableType
    ...
    static {
        log.debug("[CloudPivot Starter] - Auto Configuration 'DataPermission' completed initialization.");
    }
}
