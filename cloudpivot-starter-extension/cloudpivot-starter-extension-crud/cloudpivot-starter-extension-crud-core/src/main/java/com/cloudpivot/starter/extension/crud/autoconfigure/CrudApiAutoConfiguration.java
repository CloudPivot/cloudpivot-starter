...
package com.cloudpivot.starter.extension.crud.autoconfigure;
...
import com.cloudpivot.starter.extension.crud.aop.CrudApiAnnotationAdvisor;
import com.cloudpivot.starter.extension.crud.aop.CrudApiAnnotationInterceptor;
...
public class CrudApiAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'Extension-CRUD API' completed initialization.");
    }
}
