...
import com.cloudpivot.starter.data.datapermission.DataPermissionDialect;
import com.cloudpivot.starter.data.datapermission.DataPermissionFilter;
...
public class MybatisFlexAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'MyBatis Flex' completed initialization.");
