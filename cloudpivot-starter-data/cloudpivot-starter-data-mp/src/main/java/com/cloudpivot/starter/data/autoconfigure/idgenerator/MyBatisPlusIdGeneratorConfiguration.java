...
package com.cloudpivot.starter.data.autoconfigure.idgenerator;
...
import com.cloudpivot.starter.data.idgenerator.MyBatisPlusCosIdIdentifierGenerator;
...
public class MyBatisPlusIdGeneratorConfiguration {
    ...
    static class Default {
        ...
        public IdentifierGenerator identifierGenerator() {
            log.debug("[CloudPivot Starter] - Auto Configuration 'MyBatis Plus-IdGenerator-Default' completed initialization.");
    ...
    static class CosId {
        ...
        @Bean
        public IdentifierGenerator identifierGenerator() {
            log.debug("[CloudPivot Starter] - Auto Configuration 'MyBatis Plus-IdGenerator-CosId' completed initialization.");
    ...
    static class Custom {
        ...
        public IdentifierGenerator identifierGenerator() {
            if (log.isErrorEnabled()) {
                log.error("[CloudPivot Starter] - When 'mybatis-plus.extension.id-generator.type' is 'custom', you must provide a bean of type '{}' in your configuration.", ResolvableType
        ...
        public void postConstruct() {
            log.debug("[CloudPivot Starter] - Auto Configuration 'MyBatis Plus-IdGenerator-Custom' completed initialization.");
        }
    }
}