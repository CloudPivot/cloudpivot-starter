...
package com.cloudpivot.starter.cache.redisson.autoconfigure;
...
import com.cloudpivot.starter.cache.redisson.handler.NameMapperHandler;
...
public class RedissonAutoConfiguration {
    ...
    public RedissonAutoConfigurationCustomizer redissonAutoConfigurationCustomizer() {
        return config -> {
            ...
            log.debug("[CloudPivot Starter] - Auto Configuration 'Redisson' completed initialization.");
        };
    }
