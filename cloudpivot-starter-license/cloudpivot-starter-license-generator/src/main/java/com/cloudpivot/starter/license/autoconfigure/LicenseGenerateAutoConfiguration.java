...
import com.cloudpivot.starter.license.service.LicenseCreateService;
...
public class LicenseGenerateAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'License-Generator' completed initialization.");
    }
}
