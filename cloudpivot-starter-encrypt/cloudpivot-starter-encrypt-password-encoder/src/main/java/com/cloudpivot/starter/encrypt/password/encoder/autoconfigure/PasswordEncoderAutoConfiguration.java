...
package com.cloudpivot.starter.encrypt.password.encoder.autoconfigure;
...
import com.cloudpivot.starter.encrypt.password.encoder.enums.PasswordEncoderAlgorithm;
import com.cloudpivot.starter.encrypt.password.encoder.util.PasswordEncoderUtil;
...
public class PasswordEncoderAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'Encrypt-Password Encoder' completed initialization.");
    }
}
