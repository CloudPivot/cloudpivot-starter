...
package com.cloudpivot.starter.encrypt.api.autoconfigure;
...
import com.cloudpivot.starter.encrypt.api.filter.ApiEncryptFilter;
...
public class ApiEncryptAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'Encrypt-API' completed initialization.");
    }
}
