...
package com.cloudpivot.starter.encrypt.field.autoconfigure;
...
import com.cloudpivot.starter.encrypt.field.interceptor.MyBatisDecryptInterceptor;
import com.cloudpivot.starter.encrypt.field.interceptor.MyBatisEncryptInterceptor;
import com.cloudpivot.starter.encrypt.field.util.EncryptHelper;
...
public class FieldEncryptAutoConfiguration {
    ...
    public void postConstruct() {
        ...
        log.debug("[CloudPivot Starter] - Auto Configuration 'Encrypt-Field' completed initialization.");
    }
}
