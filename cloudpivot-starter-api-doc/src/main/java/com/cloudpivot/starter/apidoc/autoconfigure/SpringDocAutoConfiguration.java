...
package com.cloudpivot.starter.apidoc.autoconfigure;
...
import com.cloudpivot.starter.apidoc.processor.BaseEnumProcessor;
import com.cloudpivot.starter.core.autoconfigure.application.ApplicationProperties;
...
public class SpringDocAutoConfiguration implements WebMvcConfigurer {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'ApiDoc' completed initialization.");
    }
}
