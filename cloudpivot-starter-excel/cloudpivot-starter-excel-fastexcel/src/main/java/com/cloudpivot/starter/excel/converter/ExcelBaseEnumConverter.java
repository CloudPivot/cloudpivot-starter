...
package com.cloudpivot.starter.excel.converter;
...
public class ExcelBaseEnumConverter implements Converter<BaseEnum<?>> {
    ...
    public BaseEnum<?> convertToJavaData(ReadCellData<?> cellData,
        ...
        return castBaseEnum(BaseEnum.getByDescription(cellData.getStringValue(), castEnumType(contentProperty.getField()
            .getType())));
    }
    ...
    private Class castEnumType(Class<?> type) {
        return type;
    }

    private BaseEnum<?> castBaseEnum(Enum<?> value) {
