...
package cc.cloudpivot.starter.security.xss.filter;
...
import cc.cloudpivot.starter.security.xss.autoconfigure.XssProperties;
...
public class XssFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) {
        log.debug("[CloudPivot Starter] - Auto Configuration 'Web-XssFilter' completed initialization.");
    }
