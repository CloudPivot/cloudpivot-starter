...
package com.cloudpivot.starter.security.xss.autoconfigure;
...
import com.cloudpivot.starter.security.xss.filter.XssFilter;
...
public class XssAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'Security-XSS' completed initialization.");
    }
}
