...
package com.cloudpivot.starter.captcha.behavior.autoconfigure;
...
import com.cloudpivot.starter.captcha.behavior.autoconfigure.cache.BehaviorCaptchaCacheConfiguration;
...
public class BehaviorCaptchaAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'Captcha-Behavior' completed initialization.");
    }
}
