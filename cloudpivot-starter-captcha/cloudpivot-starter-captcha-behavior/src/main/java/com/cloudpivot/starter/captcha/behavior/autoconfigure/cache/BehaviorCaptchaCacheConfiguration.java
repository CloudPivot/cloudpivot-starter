...
package com.cloudpivot.starter.captcha.behavior.autoconfigure.cache;
...
import com.cloudpivot.starter.captcha.behavior.cache.BehaviorCaptchaCacheService;
import com.cloudpivot.starter.captcha.behavior.enums.StorageType;
...
public class BehaviorCaptchaCacheConfiguration {
    ...
    static class Default {
        ...
        public CaptchaCacheService captchaCacheService() {
            ...
            log.debug("[CloudPivot Starter] - Auto Configuration 'Captcha-Behavior-Cache-Default' completed initialization.");
            return service;
        }
    }
    ...
    static class Redis {
        ...
        @Bean
        public CaptchaCacheService captchaCacheService(RedissonClient redissonClient) {
            ...
            log.debug("[CloudPivot Starter] - Auto Configuration 'Captcha-Behavior-Cache-Redis' completed initialization.");
            return service;
        }
    }
    ...
    static class Custom {
        ...
        public void postConstruct() {
            try {
                ...
                log.debug("[CloudPivot Starter] - Auto Configuration 'Captcha-Behavior-Cache-Custom' completed initialization.");
            } catch (Exception e) {
                log.error("[CloudPivot Starter] - When 'cloudpivot-starter.captcha.behavior.cache-type' is 'custom', you must provide a bean of type '{}' in your configuration.", ResolvableType
