...
package com.cloudpivot.starter.captcha.graphic.autoconfigure;
...
import com.cloudpivot.starter.captcha.graphic.core.GraphicCaptchaService;
...
public class GraphicCaptchaAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'Captcha-Graphic' completed initialization.");
    }
}
