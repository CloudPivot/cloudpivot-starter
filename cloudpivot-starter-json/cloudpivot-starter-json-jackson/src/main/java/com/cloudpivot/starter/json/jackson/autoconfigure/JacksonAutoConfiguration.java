...
package com.cloudpivot.starter.json.jackson.autoconfigure;
...
import com.cloudpivot.starter.core.enums.BaseEnum;
import com.cloudpivot.starter.core.util.GeneralPropertySourceFactory;
import com.cloudpivot.starter.json.jackson.serializer.BaseEnumDeserializer;
import com.cloudpivot.starter.json.jackson.serializer.BaseEnumSerializer;
import com.cloudpivot.starter.json.jackson.serializer.BigNumberSerializer;
import com.cloudpivot.starter.json.jackson.serializer.SimpleDeserializersWrapper;
...
public class JacksonAutoConfiguration {
    ...
    public Jackson2ObjectMapperBuilderCustomizer jackson2ObjectMapperBuilderCustomizer() {
        return builder -> {
            ...
            log.debug("[CloudPivot Starter] - Auto Configuration 'Jackson' completed initialization.");
        };
    }
    ...
    private SimpleModule bigNumberModule() {
        ...
        switch (properties.getBigNumberSerializeMode()) {
            ...
            default -> log.warn("[CloudPivot Starter] - Jackson 大数值序列化模式：NO_OPERATE，超过 JS 范围的数值会损失精度");
        }
