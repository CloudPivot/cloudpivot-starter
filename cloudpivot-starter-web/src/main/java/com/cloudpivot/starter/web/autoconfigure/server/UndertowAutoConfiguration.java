...
package com.cloudpivot.starter.web.autoconfigure.server;
...
import com.cloudpivot.starter.core.util.CollUtils;
...
public class UndertowAutoConfiguration {
    ...
    public WebServerFactoryCustomizer<UndertowServletWebServerFactory> customize(ServerExtensionProperties properties) {
        return factory -> {
            ...
            log.debug("[CloudPivot Starter] - Disallowed HTTP methods on Server Undertow: {}.", properties
                .getDisallowedMethods());
            log.debug("[CloudPivot Starter] - Auto Configuration 'Web-Server Undertow' completed initialization.");
        };
    }
}
