...
package com.cloudpivot.starter.log.handler;
...
import com.cloudpivot.starter.log.annotation.Log;
import com.cloudpivot.starter.log.enums.Include;
import com.cloudpivot.starter.log.http.RecordableHttpRequest;
import com.cloudpivot.starter.log.http.RecordableHttpResponse;
import com.cloudpivot.starter.log.http.servlet.RecordableServletHttpRequest;
import com.cloudpivot.starter.log.http.servlet.RecordableServletHttpResponse;
import com.cloudpivot.starter.log.model.AccessLogContext;
import com.cloudpivot.starter.log.model.AccessLogProperties;
import com.cloudpivot.starter.log.model.LogRecord;
import com.cloudpivot.starter.log.util.AccessLogUtils;
...
public abstract class AbstractLogHandler implements LogHandler {
    ...
    public void logDescription(LogRecord logRecord, Method targetMethod) {
        logRecord.setDescription("请在该接口方法上添加 @com.cloudpivot.starter.log.annotation.Log(value) 来指定日志描述");
        Log methodLog = AnnotationUtil.getAnnotation(targetMethod, Log.class);
        // 例如：@Log("新增部门") -> 新增部门
    ...
    public void logModule(LogRecord logRecord, Method targetMethod, Class<?> targetClass) {
        logRecord.setModule("请在该接口方法或类上添加 @com.cloudpivot.starter.log.annotation.Log(module) 来指定所属模块");
        Log methodLog = AnnotationUtil.getAnnotation(targetMethod, Log.class);
