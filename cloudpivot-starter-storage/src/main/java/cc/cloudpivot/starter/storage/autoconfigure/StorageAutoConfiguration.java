...
package cc.cloudpivot.starter.storage.autoconfigure;

import cc.cloudpivot.starter.storage.processor.preprocess.FileNameGenerator;
import cc.cloudpivot.starter.storage.processor.preprocess.FilePathGenerator;
import cc.cloudpivot.starter.storage.processor.preprocess.FileValidator;
import cc.cloudpivot.starter.storage.processor.preprocess.ThumbnailProcessor;
import cc.cloudpivot.starter.storage.processor.preprocess.impl.*;
...
import cc.cloudpivot.starter.storage.annotation.PlatformProcessor;
import cc.cloudpivot.starter.storage.autoconfigure.properties.StorageProperties;
import cc.cloudpivot.starter.storage.core.FileStorageService;
import cc.cloudpivot.starter.storage.engine.StorageDecoratorManager;
import cc.cloudpivot.starter.storage.processor.registry.ProcessorRegistry;
import cc.cloudpivot.starter.storage.processor.preprocess.*;
import cc.cloudpivot.starter.storage.processor.preprocess.impl.*;
import cc.cloudpivot.starter.storage.engine.StorageStrategyRegistrar;
import cc.cloudpivot.starter.storage.engine.StorageStrategyRouter;
import cc.cloudpivot.starter.storage.service.FileProcessor;
import cc.cloudpivot.starter.storage.service.FileRecorder;
import cc.cloudpivot.starter.storage.service.impl.DefaultFileRecorder;
...
public class StorageAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'Storage' completed initialization.");
    }
}
