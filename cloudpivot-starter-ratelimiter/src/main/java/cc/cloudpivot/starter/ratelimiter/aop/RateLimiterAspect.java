...
package cc.cloudpivot.starter.ratelimiter.aop;
...
import cc.cloudpivot.starter.cache.redisson.util.RedisUtils;
import cc.cloudpivot.starter.core.constant.StringConstants;
import cc.cloudpivot.starter.core.util.expression.ExpressionUtils;
import cc.cloudpivot.starter.ratelimiter.annotation.RateLimiter;
import cc.cloudpivot.starter.ratelimiter.annotation.RateLimiters;
import cc.cloudpivot.starter.ratelimiter.autoconfigure.RateLimiterProperties;
import cc.cloudpivot.starter.ratelimiter.generator.RateLimiterNameGenerator;
import cc.cloudpivot.starter.ratelimiter.enums.LimitType;
import cc.cloudpivot.starter.ratelimiter.exception.RateLimiterException;
...
public class RateLimiterAspect {
     ...
     * 单个限流注解切点
     */
    @Pointcut("@annotation(cc.cloudpivot.starter.ratelimiter.annotation.RateLimiter)")
     ...
     * 多个限流注解切点
     */
    @Pointcut("@annotation(cc.cloudpivot.starter.ratelimiter.annotation.RateLimiters)")
