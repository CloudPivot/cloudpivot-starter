...
package com.cloudpivot.starter.auth.justauth.autoconfigure;
...
import com.cloudpivot.starter.auth.justauth.AuthRequestFactory;
import com.cloudpivot.starter.auth.justauth.autoconfigure.cache.JustAuthStateCacheConfiguration;
 ...
 * @since 1.0.0
 */
@AutoConfiguration(afterName = "com.cloudpivot.starter.cache.redisson.autoconfigure.RedissonAutoConfiguration")
...
public class JustAuthAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'JustAuth' completed initialization.");
    }
}