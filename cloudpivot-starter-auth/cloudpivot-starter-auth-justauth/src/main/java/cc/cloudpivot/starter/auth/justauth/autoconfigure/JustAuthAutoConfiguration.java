...
package cc.cloudpivot.starter.auth.justauth.autoconfigure;
...
import cc.cloudpivot.starter.auth.justauth.AuthRequestFactory;
import cc.cloudpivot.starter.auth.justauth.autoconfigure.cache.JustAuthStateCacheConfiguration;
 ...
 * @since 1.0.0
 */
@AutoConfiguration(afterName = "cc.cloudpivot.starter.cache.redisson.autoconfigure.RedissonAutoConfiguration")
