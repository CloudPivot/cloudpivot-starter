...
package com.cloudpivot.starter.auth.satoken.autoconfigure;
...
import com.cloudpivot.starter.auth.satoken.autoconfigure.dao.SaTokenDaoConfiguration;
...
public class SaTokenAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'SaToken' completed initialization.");
    }
}
