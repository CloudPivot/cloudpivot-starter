...
package com.cloudpivot.starter.auth.satoken.autoconfigure.dao;
...
public class SaTokenDaoConfiguration {
    ...
    static class Default {
        ...
        public SaTokenDao saTokenDao() {
            log.debug("[CloudPivot Starter] - Auto Configuration 'SaToken-Dao-Default' completed initialization.");
    ...
    static class Redis {
        ...
        public SaTokenDao saTokenDao(RedissonClient redissonClient) {
            log.debug("[CloudPivot Starter] - Auto Configuration 'SaToken-Dao-Redis' completed initialization.");
    ...
    static class Custom {
        ...
        public SaTokenDao saTokenDao() {
            if (log.isErrorEnabled()) {
                log.error("[CloudPivot Starter] - When 'sa-token.extension.dao.type' is 'custom', you must provide a bean of type '{}' in your configuration.", ResolvableType
        ...
        public void postConstruct() {
            log.debug("[CloudPivot Starter] - Auto Configuration 'SaToken-Dao-Custom' completed initialization.");
        }
    }
}