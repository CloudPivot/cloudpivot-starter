...
package com.cloudpivot.starter.messaging.websocket.autoconfigure;
...
import com.cloudpivot.starter.messaging.websocket.core.WebSocketClientService;
import com.cloudpivot.starter.messaging.websocket.core.WebSocketInterceptor;
import com.cloudpivot.starter.messaging.websocket.dao.DefaultWebSocketSessionDao;
import com.cloudpivot.starter.messaging.websocket.dao.WebSocketSessionDao;
...
public class WebSocketAutoConfiguration {
    ...
    public WebSocketHandler webSocketHandler(WebSocketSessionDao webSocketSessionDao) {
        return new com.cloudpivot.starter.messaging.websocket.core.WebSocketHandler(properties, webSocketSessionDao);
    }
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'Messaging-WebSocket' completed initialization.");
    }
}
