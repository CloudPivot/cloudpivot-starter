...
package com.cloudpivot.starter.messaging.mail.autoconfigure;
...
import com.cloudpivot.starter.core.util.MapUtils;
...
public class MailAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[CloudPivot Starter] - Auto Configuration 'Mail' completed initialization.");
    }
}
